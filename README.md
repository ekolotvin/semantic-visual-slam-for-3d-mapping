...
Чтобы построить полную карту сцены:
...
В результате получается глобальная 3D карта поверхности сцены с семантической разметкой:

![1](https://github.com/user-attachments/assets/7b0e49f2-b7bd-4c24-b12e-a97eb3bb9766)
