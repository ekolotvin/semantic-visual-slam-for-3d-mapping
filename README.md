...
Дообучался только классификационный слой;<br> 
50 эпох обучения;<br> 
Лучшая модель сохранена по метрике mIoU на валидации;<br> 
...
Новая инициализация DeepLabV3+;<br>
Дообучался только классификационный слой;<br>
50 эпох обучения;<br>
Лучшая модель сохранена по метрике mIoU на валидации;<br>

**Оценка переносимости (Cross-Domain).**<br>
Для анализа обобщающей способности *kitti_model* протестирована на тестовой части BDD100K;<br>
*bdd_model* оценена на своём тестовом наборе.
